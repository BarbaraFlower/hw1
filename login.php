...
<html>
    ...
    <body>
        ...
        <section id="mainLogin">
            <div class="sezione">
                <h1>Registrati</h1>
                <p>per entare nel mondo Pavesini</p>
                <div class="prosegui" >
                    <a href="registrazione.php">Prosegui</a>
                </div>
            </div>
                ...
                <div>
                  ...
                  <div class="form-accedi">
                      <form method="post">
                          ...
                          <h4 id="email_empty" class="hidden">Questo campo è obbligatorio!</h4>
                          <p>Password</p>
                          <input type="password" id="password" name="password">
                          <h4 id="password_empty" class="hidden">Questo campo è obbligatorio!</h4>
                          <?php
                                if (isset($error)) {
                      ...
                      <div class="rimaniconnesso">
                      <input type="checkbox" name="" id=""> rimani connesso
        ...
        <div id="privacy"> Per conoscere come ci prendiamo cura dei tuoi dati personali, consulta la nostra 
 ...
 <!--FOOTER-->
        ...
        <div id="icone">
                ...
                <div class="border_icon">
                    <a href="https://open.spotify.com/user/314dxbsruiaun4dtinu2tjb7msya">
                        <img src="icons8-web-accessibility-100.png">
                    </a>
                </div>
