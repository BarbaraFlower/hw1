...
<html>
    ...
    <body>
        ...
        <section id="main">
            ...
            <section id="centrale">
            <section id="pubblicita_concorso">
                
                <a href="https://www.instagram.com/pavesini_official/"><img id="vinci" src="Banner-Desk-Home-V1.png" alt=""></a>
                <a href="https://www.instagram.com/pavesini_official/"><img id="vinci2" src="	https://www.pavesini.it/wp-content/uploads/2024/03/Banne-Hom-Mob-V1.png" alt=""></a>
                ...
                <!--API VIAGGIO-->
                <section id="travel">
                    <button id="itinerario"><h1>CREA ITINERARIO</h1></button>
                    <div id="travel2"  class="hidden">
                        <form>
                            Partecipa al concorso e scopri quante cose fare nelle città del contest!
            ...
            <section class="scopri">
                ...
                <div class="pavesino">
                        ...
                        <div data-index="1">
                            <a  href="https://www.pavesini.it/prodotti/pavesini-originali/"> 
                                <img src="	https://www.pavesini.it/wp-content/uploads/2023/07/originali_off.png">
                            </a>
                        </div>

                        <div data-index="2"> 
                            <a href="https://www.pavesini.it/prodotti/pavesini-al-cacao/"> 
                                <img src="	https://www.pavesini.it/wp-content/uploads/2023/07/cacao_off.png">
                            </a>
                        </div>

                        <div data-index="3">
                            <a href="https://www.pavesini.it/prodotti/pavesini-al-caffe/">
                                <img src="https://www.pavesini.it/wp-content/uploads/2023/07/caffe_off.png">
                        </a>
                        </div>

                        <div data-index="4">
                            <a href="https://www.pavesini.it/prodotti/pavesini-double/">
                                <img src="	https://www.pavesini.it/wp-content/uploads/2023/07/double_off.png">
                            </a>
                        </div>
                ...
                <section id="spotify">
                    ...
                    <h1>Non sai che cucinare?</h1>
                    <h2>Vedi i podcast di GialloZafferano</h2>
                    <button id='podcast'>Podcast</button>
                    <section id="podcast-view">
                    </section>

                </section>

            
                <!--RICETTE CON PAVESINI-->

            <section id="ricette">

                <h1>Le ricette con pavesini</h1>

                <div id="container">

                    <div class="descrizione" >
                    
                            <a href="https://www.pavesini.it/ricette/tiramisu-scomposto/"><img  src="https://www.pavesini.it/wp-content/uploads/2023/10/tiramisu-scomposto-con-pavesini-listing.jpg" >
                            </a>
                    
                        <div class="box">
                            <h2>Tiramisù scomposto</h2>
                            <p>un classico rivisitato in chiave</br> moderna</p>
                            <span><a class="button" href="https://www.pavesini.it/ricette/tiramisu-scomposto/">scopri</a></span>
                        </div>
                    </div>

                    <div class="descrizione">
                    
                            <a href="https://www.pavesini.it/ricette/tiramisu-allananas/">
                                <img src="	https://www.pavesini.it/wp-content/uploads/2023/10/tiramisu-all-ananas-con-pavesini-listing.jpg" >
                            </a>
                    
                            <div class="box">
                                <h2>Tiramisù all'anas</h2>
                                <p>un variante esotica del dessert</br> tradizionale</p>
                                <span><a class="button" href="https://www.pavesini.it/ricette/tiramisu-allananas/">scopri</a></span>
                            </div>
                    </div>

                    <div class="descrizione">
                    
                            <a href="https://www.pavesini.it/ricette/tiramisu-con-panna/"><img src="	https://www.pavesini.it/wp-content/uploads/2023/10/tiramisu-con-panna-pavesini-listing.jpg">
                            </a>
                        
                            <div class="box">
                                <h2>Tiramisù con panna</h2>
                                <p>la deliziosa variante del classico </br>tiramisù</p>
                                <span><a class="button" href="https://www.pavesini.it/ricette/tiramisu-con-panna/">scopri</a></span>
                            </div>
                    </div>
            </div>
            
            <section id="ricettadistagione"></section>
            
            <span class="button2" id="nuovaricetta">Ricetta Di Stagione</span>

            <div><a class="button2"  href="https://www.pavesini.it/ricette/">Scopri le altre ricette</a></div>
            ...
            <section id="api">
                <form id="cerca_ricetta">
                    Inserisci un numero per farti ispirare da nuove ricette!
                    <input id="iniziale_id" type="text" />
                    <input type="submit" id="submit2" value="cerca">
                </form>
                <section id="visualizza_ricette">
